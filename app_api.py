...
class AimaraAPI:
    ...
    def complete_exchange(self, payload):
        ...
        success, message, new_total, original_total, diferencia = ReturnModel.complete_exchange(
        ...
        return self._response(True, message, {"new_total": new_total, "original_total": original_total, "diferencia": diferencia, "output": "/receipt.pdf"})
    ...
    def update_sale_item(self, payload):
        ...
        success, message, new_total, original_total, diferencia = ReturnModel.update_sale_item(
